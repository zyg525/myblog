...
const DOMAIN_NAME = 'zyg.com' // 域名 (不带https)
  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        ...
        items: [
          {
            text: 'JVM', link: '/pages/d71a6d/'
          },
          {
            text: 'Java语言基础', link: '/pages/e9f21d/'
          },
          {
            text: 'JavaWeb', link: '/pages/ce8312/'
          },
          {
            text: 'Spring框架', link: '/pages/a4834e/'
          },
        ]
      },
      {
      ...
      {
       text: '旧博客', link: 'https://zyg525.github.io/'
      },
    ],
    sidebarDepth: 2, // 侧边栏显示深度，默认1，最大2（显示到h3标题）
    logo: '/img/logo.png', // 导航栏logo
    repo: 'zyg525/myblog', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'zyg', // 必需
      link: 'https://github.com/zyg525', // 可选的
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/playlist?id=123007714&userid=102483138',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'ZYG | <a href="https://github.com/zyg525/myblog/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'zyg525', // GitHub仓库所有者
          admin: ['zyg525'], // 对仓库有写权限的人
