...
![](/img/mall/springcloud_admin_01.png)

- 点击wallboard按钮，选择admin-client查看监控信息；

- 监控信息概览；

![](/img/mall/springcloud_admin_02.png)

- 度量指标信息，比如JVM、Tomcat及进程信息；

![](/img/mall/springcloud_admin_03.png)

- 环境变量信息，比如系统属性、系统环境变量以及应用配置信息；

![](/img/mall/springcloud_admin_04.png)

- 查看所有创建的Bean信息；

![](/img/mall/springcloud_admin_05.png)

- 查看应用中的所有配置信息；

![](/img/mall/springcloud_admin_06.png)
...
![](/img/mall/springcloud_admin_07.png)

- 查看JVM信息；

![](/img/mall/springcloud_admin_08.png)

- 查看可以访问的Web端点；

![](/img/mall/springcloud_admin_09.png)

- 查看HTTP跟踪信息；

![](/img/mall/springcloud_admin_10.png)
...
![](/img/mall/springcloud_admin_11.png)

- 查看Spring Boot Admin 主页发现可以看到服务信息：http://localhost:9301

![](/img/mall/springcloud_admin_12.png)
...
![](/img/mall/springcloud_admin_13.png)
