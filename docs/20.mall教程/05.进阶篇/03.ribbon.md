...
![](/img/mall/springcloud_ribbon_01.png)
- 此时运行中的服务如下：

![](/img/mall/springcloud_ribbon_02.png)
- 调用接口进行测试：[http://localhost:8301/user/1](http://localhost:8301/user/1)

![](/img/mall/springcloud_ribbon_05.png)
- 可以发现运行在8201和8202的user-service控制台交替打印如下信息：

![](/img/mall/springcloud_ribbon_03.png)

![](/img/mall/springcloud_ribbon_04.png)
