---
title: mall在Linux环境下的部署（基于Docker容器）
date: 2024-03-31 23:13:22
permalink: /pages/edf115/
categories:
  - mall教程
  - deploy
tags:
...
![](/img/mall/mall_linux_deploy_01.png)
...
![](/img/mall/mall_linux_deploy_02.png)
...
![](/img/mall/mall_linux_deploy_03.png)

- 输入账号密码并登录：guest guest

- 创建帐号并设置其角色为管理员：mall mall

![](/img/mall/mall_linux_deploy_04.png)

- 创建一个新的虚拟host为：/mall

![](/img/mall/mall_linux_deploy_05.png)

- 点击mall用户进入用户配置页面

![](/img/mall/mall_linux_deploy_06.png)

- 给mall用户配置该虚拟host的权限

![](/img/mall/mall_linux_deploy_07.png)
...
![](/img/mall/mall_linux_deploy_08.png)
...
![](/img/mall/mall_linux_deploy_09.png)
...
![](/img/mall/mall_linux_deploy_10.png)
...
![](/img/mall/mall_linux_deploy_11.png)

- 直接双击根项目`mall`的`package`命令可以一次性打包所有应用的Docker镜像；

![](/img/mall/mall_linux_deploy_12.png)
