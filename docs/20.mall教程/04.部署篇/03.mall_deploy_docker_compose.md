...
具体参考：[开发者必备Docker命令](../06.参考篇/docker.md)

## docker-compose环境搭建及使用

具体参考：[使用Docker Compose部署SpringBoot应用](../06.参考篇/docker_compose.md)
...
需要打包mall-admin、mall-search、mall-portal的docker镜像，具体参考：[使用Maven插件为SpringBoot应用构建Docker镜像](../06.参考篇/docker_maven.md)
...
![](/img/mall/mall_docker_compose_03.png)
...
![](/img/mall/mall_docker_compose_05.png)

- 输入账号密码并登录：guest guest

- 创建帐号并设置其角色为管理员：mall mall

![](/img/mall/mall_docker_compose_06.png)

- 创建一个新的虚拟host为：/mall

![](/img/mall/mall_docker_compose_07.png)

- 点击mall用户进入用户配置页面

![](/img/mall/mall_docker_compose_08.png)

- 给mall用户配置该虚拟host的权限

![](/img/mall/mall_docker_compose_09.png)
...
![](/img/mall/mall_docker_compose_04.png)
...
![](/img/mall/mall_docker_compose_01.png)

![](/img/mall/mall_docker_compose_02.png)
