...
![](/img/mall/spring_boot_redis_01.png)

- 下载完后解压到指定目录；

![](/img/mall/spring_boot_redis_02.png)

- 在当前地址栏输入cmd后，执行redis的启动命令：redis-server.exe redis.windows.conf

![](/img/mall/spring_boot_redis_03.png)
...
![](/img/mall/spring_boot_redis_04.png)
...
![](/img/mall/spring_boot_redis_05.png)
