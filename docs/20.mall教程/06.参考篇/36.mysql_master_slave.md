...
![](/img/mall/mysql_master_slave_06.png)
...
![](/img/mall/mysql_master_slave_01.png)
...
![](/img/mall/mysql_master_slave_02.png)
...
![](/img/mall/mysql_master_slave_03.png)
...
![](/img/mall/mysql_master_slave_04.png)

- 在从实例中查看数据库，发现也有一个`mall`数据库，可以判断主从复制已经搭建成功。

![](/img/mall/mysql_master_slave_05.png)
