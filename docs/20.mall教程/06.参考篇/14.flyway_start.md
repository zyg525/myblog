---
title: 据库迁移搞炸了！没用这款开源神器的锅？
date: 2024-03-31 23:13:22
permalink: /pages/7bc719/
categories:
  - mall教程
  - reference
tags:
...
![](/img/mall/flyway_start_03.png)

- 下载完成后进行解压，解压完成后目录结构如下；


![](/img/mall/flyway_start_04.png)
...
![](/img/mall/flyway_start_10.png)

- Flyway的Maven插件支持如下几种命令；


![](/img/mall/flyway_start_11.png)
