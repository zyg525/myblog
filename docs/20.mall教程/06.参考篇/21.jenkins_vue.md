...
![](/img/mall/jenkins_vue_01.png)

- 搜索`NodeJS`插件并进行安装；

![](/img/mall/jenkins_vue_02.png)

### 配置NodeJS插件

- 在系统设置->全局工具配置中进行插件配置；

![](/img/mall/jenkins_vue_03.png)

- 选择`新增NodeJS`，配置好版本号以后，点击保存即可完成设置；

![](/img/mall/jenkins_vue_04.png)
