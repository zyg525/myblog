...
- 执行maven的package命令:  
![](/img/mall/refer_screen_68.png)
- 构建成功:  
![](/img/mall/refer_screen_66.png)
- 镜像仓库已有该镜像：  
![](/img/mall/refer_screen_67.png)
...
```
![](/img/mall/refer_screen_69.png)
- 修改root帐号的权限，使得任何ip都能访问：
```sql
grant all privileges on *.* to 'root'@'%'
```
![](/img/mall/refer_screen_70.png)
- 创建mall数据库：
```sql
