...
![](/img/mall/mybatis_plus_start_01.png)

- 生成单表代码结构一览；

![](/img/mall/mybatis_plus_start_02.png)

- 另一种直接生成整个模块的代码，需要带通配符`*`，比如生成`ums`模块代码可以先输入`ums`，后输入`ums_*`；

![](/img/mall/mybatis_plus_start_03.png)

- 生成整个模块代码结构一览。

![](/img/mall/mybatis_plus_start_04.png)
...
![](/img/mall/mybatis_plus_start_05.png)
...
![](/img/mall/mybatis_plus_start_06.png)
...
![](/img/mall/mybatis_plus_start_07.png)
