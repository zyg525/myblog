---
title: Nginx如何支持HTTPS？手把手教贼简单！
date: 2024-03-31 23:13:22
permalink: /pages/cc0973/
categories:
  - mall教程
  - reference
tags:
...
![](/img/mall/nginx_https_start_01.png)

- 我们可以查看下证书的`颁发者`信息，可以发现正好是之前我们创建SSL证书签名请求文件时录入的信息；

![](/img/mall/nginx_https_start_02.png)
...
![](/img/mall/nginx_https_start_03.png)

- 任意调用一个接口测试下，比如说登录接口，可以发现已经可以通过HTTPS正常访问SpringBoot应用提供的接口。

![](/img/mall/nginx_https_start_04.png)
...
![](/img/mall/nginx_https_start_05.png)

- 申请成功后点击下载Nginx证书即可；

![](/img/mall/nginx_https_start_06.png)
...
![](/img/mall/nginx_https_start_09.png)
