...
![](/img/mall/arch_screen_04.png)

#### 对请求参数已经添加说明

![](/img/mall/arch_screen_05.png)

#### 对返回结果已经添加说明

![](/img/mall/arch_screen_06.png)

### 直接在在线文档上面进行接口测试

![](/img/mall/arch_screen_07.png)

![](/img/mall/arch_screen_08.png)
