...
![](/img/mall/arch_screen_14.png)

### 未登录前访问接口

![](/img/mall/arch_screen_15.png)

![](/img/mall/arch_screen_16.png)

### 登录后访问接口

- 进行登录操作：登录帐号test 123456

![](/img/mall/arch_screen_17.png)

![](/img/mall/arch_screen_18.png)

- 点击Authorize按钮，在弹框中输入登录接口中获取到的token信息

![](/img/mall/arch_screen_19.png)

![](/img/mall/arch_screen_20.png)

- 登录后访问获取权限列表接口，发现已经可以正常访问

![](/img/mall/arch_screen_15.png)

![](/img/mall/arch_screen_21.png)

### 访问需要权限的接口

> 由于test帐号并没有设置任何权限，所以他无法访问具有`pms:brand:read`权限的获取品牌列表接口。

![](/img/mall/arch_screen_22.png)

![](/img/mall/arch_screen_23.png)
