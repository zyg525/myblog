...
<img src="/img/java/线程的6种状态.png" alt="线程的6种状态" style="zoom:80%;" />
...
<img src="/img/java/锁升级过程.png" style="zoom:80%;" />
...
<img src="/img/java/线程数量的经验公式.png" alt="线程数量的经验公式" style="zoom: 80%;" />
